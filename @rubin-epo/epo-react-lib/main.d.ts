...
export declare const Figure: FunctionComponent<FigureProps>;
...
declare interface HorizontalSliderProps extends Pick<ReactSliderProps<number | readonly number[]>, "value" | "min" | "max" | "step" | "className" | "ariaValuetext" | "defaultValue"> {
