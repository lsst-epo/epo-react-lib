import{j as a}from"./jsx-runtime-94f6e698.js";import{r as l}from"./index-8db94870.js";import{s as c}from"./styled-components.browser.esm-3d9e3c21.js";const o=({children:e,className:t,forIds:s})=>a.jsx("output",{role:"status",htmlFor:s==null?void 0:s.join(" "),className:t,children:e});o.displayName="Atomic.Toast";const d=c(o)`
  position: absolute;
  top: 0;
  left: 0;
  z-index: 1;
