...
`,v=n=>{const{margin:d}=n,{left:p=0,right:x=0}=d||{},h=[0+p,400-x],[t,a]=f.useState(n.xDomain||[0,400]),b=y(t,h);return e.jsxs(C,{children:[e.jsx(g,{minX:0,width:400,height:400,children:e.jsx(u,{...n,xDomain:t,xScale:b})}),e.jsxs(D,{children:[e.jsx(s,{onClick:()=>a([t[0]-40,t[1]-40]),children:e.jsx(i,{icon:"Chevron"})}),e.jsx(s,{onClick:()=>a([t[0]+40,t[1]+40]),children:e.jsx(i,{icon:"Chevron"})})]})]})},r=v.bind({});r.args={ticks:10,y:375,margin:{top:25,bottom:25,left:25,right:25}};var m,c,l;r.parameters={...r.parameters,docs:{...(m=r.parameters)==null?void 0:m.docs,source:{originalSource:`args => {
  const {
    margin
  } = args;
  const {
...
}`,...(l=(c=r.parameters)==null?void 0:c.docs)==null?void 0:l.source}}};const P=["Primary"];export{r as Primary,P as __namedExportsOrder,E as default};
