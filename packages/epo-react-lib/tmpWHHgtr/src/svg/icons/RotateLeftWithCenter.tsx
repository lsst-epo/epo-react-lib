...
const RotateLeftWithCenter: FunctionComponent<SVGProps> = ({
  className,
  size = 24,
  fill = "currentColor",
}) => {
  ...
  return (
    <svg {...mergedSvgProps}>
      <title>Rotate left with center icon</title>
      <path
...
RotateLeftWithCenter.displayName = "SVG.RotateLeftWithCenter";

export default RotateLeftWithCenter;
