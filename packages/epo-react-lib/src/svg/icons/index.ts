...
import ChevronLeftElongated from "./ChevronLeftElongated";
import ChevronRightElongated from "./ChevronRightElongated";
import ChevronThin from "./ChevronThin";
...
const Icons = {
  ...
  CircularLoader,
  Chevron,
  ChevronLeftElongated,
  ChevronRightElongated,
  ChevronThin,
  Close,
  CloseCircle,
  Cloud,
